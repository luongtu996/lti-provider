...
class LtiOIDCLogin
{
    public function __construct(private Lti13Registration $registration)
    {
    }
     ...
     * @throws LtiException
     */
    public static function doLogin(Lti13Registration $registration, string $launch_url, array $request = null): RedirectResponse
    {
